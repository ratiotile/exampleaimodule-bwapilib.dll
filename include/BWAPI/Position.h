...
#pragma warning( pop )
  ...
  DLLEXPORT_TEMPLATE template class DLLEXPORT Point<int, POSITION_SCALE>;
  DLLEXPORT_TEMPLATE template class DLLEXPORT Point<int, WALKPOSITION_SCALE>;
  DLLEXPORT_TEMPLATE template class DLLEXPORT Point<int, TILEPOSITION_SCALE>;
}
